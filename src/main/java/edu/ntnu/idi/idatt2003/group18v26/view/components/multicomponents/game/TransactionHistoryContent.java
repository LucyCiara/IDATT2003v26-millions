...
/**
 * Class for the transaction history content component.
 */
public class TransactionHistoryContent extends VBox {
  ...
  /**
   * Constructs a new TransactionHistoryContent.
   */
  ...
  public void addTransaction(String week, String transactionType, 
