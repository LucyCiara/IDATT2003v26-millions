...
public class GameSnapshot {
  ...
  public int week;
  public Map<String, BigDecimal> currentStockPrices;
   ...
   * @param currentStockPrices The current prices of the stocks.
  ...
  public GameSnapshot(String playerName, BigDecimal playerMoney, 
                      ...
                      int week, Map<String, BigDecimal> currentStockPrices,
